...
class _$PptxTree extends PptxTree {
  ...
  _$PptxTree._({required this.width, required this.height}) : super._() {
    BuiltValueNullFieldError.checkNotNull(width, r'PptxTree', 'width');
    BuiltValueNullFieldError.checkNotNull(height, r'PptxTree', 'height');
  }
    ...
    final _$result = _$v ??
        new _$PptxTree._(
            width: BuiltValueNullFieldError.checkNotNull(
                width, r'PptxTree', 'width'),
            height: BuiltValueNullFieldError.checkNotNull(
                height, r'PptxTree', 'height'));
    replace(_$result);
    return _$result;
  }
}
