...
void main() {
  group('SequenceOfPages Tests', () {
    ...
    test('Should return the correct list of pages', () {
      sequenceOfPages = SequenceOfPages(sequenceOfPages: [page1, page2]);
      expect(sequenceOfPages.sequenceOfPages.length, 2);
      expect(sequenceOfPages.sequenceOfPages[0], page1);
      expect(sequenceOfPages.sequenceOfPages[1], page2);
    });
    ...
    test('Should add a page to the sequence', () {
      ...
      expect(sequenceOfPages.sequenceOfPages.length, 3);
      expect(sequenceOfPages.sequenceOfPages[2], page3);
    });
    ...
    test('Should remove a page from the sequence', () {
      ...
      expect(sequenceOfPages.sequenceOfPages.length, 1);
      expect(sequenceOfPages.sequenceOfPages[0], page2);
    });
    ...
    test('Should get the index of a page', () {
      sequenceOfPages = SequenceOfPages(sequenceOfPages: [page1, page2, page3]);
    ...
    test('Should throw RangeError for left or right page on empty sequence',
        () {
      sequenceOfPages = SequenceOfPages(sequenceOfPages: []);
