...
void main() {
  ...
  test('Should be able to create module.dart with pptx tree with single slide that has single line', () async {
    // Parse the PPTX tree
    PptxTree pptxTree = PptxParser('test/test_assets/A line.pptx').getPptxTree();
