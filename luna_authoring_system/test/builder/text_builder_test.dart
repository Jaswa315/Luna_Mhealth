...
class MockTextboxShape extends TextboxShape {
  MockTextboxShape()
      : super(
          textbody: Textbody(paragraphs: 
            [Paragraph(runs: 
              [Run(text: 'Hello World', languageID: Locale('en', 'us'), 
...
void main() {
  group('TextBuilder Tests', () {
    ...
    test('Should correctly set text children from TextboxShape', () {
      ...
      expect(textComponent.textChildren, isNotEmpty);
      expect(textComponent.textChildren.first.text, 'Hello World');
      expect(textComponent.textChildren.first.fontSize, 12.0);
      expect(textComponent.textChildren.first.fontWeight, FontWeight.normal);
      expect(textComponent.textChildren.first.fontStyle, FontStyle.normal);
