...
/// A class that is a categorfy game editor from a PowerPoint presentation
class CategoryGameEditorNode extends PrsNode {
  /// Slide ID for this category game
  late final String slideId;

  /// Constructor for a category game editor
...
/// A node for a category for a game
...
/// Constructor for the category node
  CategoryNode() {
    name = 'category';
  }
...
/// A node for text in a category game
class CategoryGameTextNode extends PrsNode {
  ...
  /// constructor for the category game
...
/// Node for an image in the category game
class CategoryGameImageNode extends PrsNode {
  /// the path of the category
  late String path;
  /// the alternate text for the imgage
  late String? altText;
  /// transform for the image
  late PrsNode transform;

  /// constructor for category game image node
